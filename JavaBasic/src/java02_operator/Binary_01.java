...
//		System.out.println("num1 + num2 =  + 16 + 6");
		...
		System.out.println("num1 - num2 = " + (num1-num2));
		System.out.println("num1 * num2 = " + (num1*num2));
		System.out.println("num1 / num2 = " + (num1/num2)); //몫 (2.666667이 아닌 2)
		...
		System.out.println( (double)num1 / (double)num2 ); 	//int로 작성 했지만 잠시 double로 바꿔서 진행
...
//		System.out.println( 2.666666666665 );	//나눗셈
