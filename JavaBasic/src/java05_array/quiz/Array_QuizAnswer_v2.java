...
public class Array_QuizAnswer_v2 {
...
//      관리비의 총 금액은 360000원 입니다.
		...
		//상수 선언
		final int FLOOR = 10; //건물의 층 수
		final int COST = 12000; //관리비
...
//		people[4] = 5; //5층 인원
		...
		//총 인원 계산
//		people[5] = people[0] + people[1] + people[2] + people[3] + people[4]; //1회용 코드 
...
//		}
		...
		for(int i=0; i<FLOOR; i++) {
			System.out.println(">>" + (i+1) + "층의 관리비는 " + fee[i] + "입니다.");
		}
		
		System.out.println();
		System.out.println("---총 관리비---");
