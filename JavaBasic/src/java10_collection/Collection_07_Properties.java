...
//		prop.setProperty("A", 100);
		...
		try {
			...
			writer = new FileWriter("C:\\Users\\gram\\Desktop\\Java\\workspace\\JavaBasic\\src\\java10_collection\\user.properties");
		
			//Properties 객체의 데이터를파일로 출력한다
			//	-> 파일에 객체의 데이터가 기록된다
		...
		try {
			...
			//파일 입력 스트링 생성
			reader = new FileReader("C:\\Users\\gram\\Desktop\\Java\\workspace\\JavaBasic\\src\\java10_collection\\user.properties");
