...
public class Scanner_01 {
	public static void main(String[] args) {
		...
		//import java.util.Scanner;   //java.util <- pacage .Scanner <- class  [ java. (기본)<- JRE에 포함   javax. (추가)   ]<-표준 라이브러리

		//java.lang. <- import 없이 사용 가능
		//Scanner <- import 선언 없이 사용 불가능
...
//		String name;
		...
		//	-> System.in : 키보드
		//	-> new Sacnner( System.in ); :키보드 입력 객체
