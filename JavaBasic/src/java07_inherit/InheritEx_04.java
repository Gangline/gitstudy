...
class Child4 extends Parent4 {
	...
	public Child4() {
		...
		//부모 생성자를 호출하는 코드, super생성자 호출 (코드로 안써도 있는거임)
		//	-> 자식클래스의 생성자는 항상super(); 첫 코드로 수행한다
		//	-> 평소에는 생략되어있따
//		super();
...
//		super(); // 있어도 실행 없어도 실행함
		
		//부모 매개변수 있는 생성자를 호출한다
		super(num);
